...
router.patch("/:id", async (req, res) => {
  ...
  if (
    ...
    requestBody.street &&
    requestBody.house_number &&
    requestBody.city &&
    requestBody.state &&
    requestBody.pincode &&
    requestBody.age &&
    requestBody.hashedPassword &&
    requestBody.reviewIds &&
    requestBody.reviewIds &&
  ...
  try {
    ...
    if (
      requestBody.profilePicture &&
      requestBody.profilePicture !== oldUser.profilePicture
    )
    ...
    if (
      requestBody.house_number &&
      requestBody.house_number !== oldUser.house_number
    )
    ...
    if (
      requestBody.hashedPassword &&
      requestBody.hashedPassword !== oldUser.hashedPassword
    )
